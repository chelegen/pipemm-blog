webpackJsonp([5], {
    F2uI: function (t, e) {
        ...
        var n = a("pFYg"), s = a.n(n), r = a("Xxa5"), i = a.n(r), o = a("exGp"), c = a.n(o), u = a("Dd8w"), l = a.n(u),
            g = a("ZYmg"), d = a("NYxO"), p = {
                data: function () {
                    return {blogs: [], page: 1, total: 0}
                }, computed: l()({}, Object(d.c)(["user"])), created: function () {
                    var t = this;
                    this.page = parseInt(this.$route.query.page) || 1, g.a.getBlogsByUserId(this.user.id, {page: this.page}).then(function (e) {
                        console.log(e), t.page = e.page, t.total = e.total, t.blogs = e.data
                    })
                }, methods: {
                    onPageChange: function (t) {
                        var e = this;
                        g.a.getBlogsByUserId(this.user.id, {page: t}).then(function (a) {
                        ...
                        return c()(i.a.mark(function a() {
                            return i.a.wrap(function (a) {
                                for (; ;) switch (a.prev = a.next) {
                                    case 0:
                                        return a.next = 2, e.$confirm("此操作将永久删除该文件, 是否继续?", "提示", {
                                            confirmButtonText: "确定",
                                            cancelButtonText: "取消",
                                            type: "warning"
                                        });
                                    case 2:
                                        return a.next = 4, g.a.deleteBlog({blogId: t});
                                    case 4:
                                        e.$message.success("删除成功"), e.blogs = e.blogs.filter(function (e) {
                                            return e.id != t
                                        });
                                    case 6:
                                    case"end":
                        ...
                        var e = "object" === (void 0 === t ? "undefined" : s()(t)) ? t : new Date(t);
        ...
        var _ = a("VU/8")(p, v, !1, function (t) {
            a("F2uI")
        }, null, null);
        e.default = _.exports
    }
});
//# sourceMappingURL=5.5be10ede79bc8d6994a5.js.map