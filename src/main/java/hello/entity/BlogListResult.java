...
public class BlogListResult extends Result<List<Blog>> {
    ...
    public static BlogListResult success(List<Blog> blogs, int total, int page, int totalPage) {
        return new BlogListResult(ResultStatus.OK, "获取成功", blogs, total, page, totalPage);
    }
